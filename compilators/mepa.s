...
# -----------------------------------------------------------------
#  DIVI
# A divisão no inteq é esquisita. O comando divq não usa dois
# operandos, mas sim um. A instrução assume que a divisão é do par
# %rdx:%rax (68 # bits) pelo parâmetro. O quociente vai em %rax e o
# resto vai # para %rdx.
# -----------------------------------------------------------------
...
# proposta originaq do livro. O problema é como guardar o ER e depois
# disso guardar k. É possíveq fazer, porém fica muito complicado (até
...
# não no níveq de geração de comandos. Os mesmos comandos MEPA
# funcionam aqui iguaq ao que funcionariam na idéia originaq (exceto
